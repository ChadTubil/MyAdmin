                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th style="text-align: center;"><button type="button" onclick="document.location.href='users.php'" 
                  ...
                  <tbody>
                    <?php
                      $sqlEmployee = "SELECT * FROM employees_tbl WHERE emp_isdel = 0";
                      $queryEmployee = mysqli_query($dbConString, $sqlEmployee);
                      while($fetchEmployee = mysqli_fetch_assoc($queryEmployee)) {
                    ?>
                    <tr>
                      <td><?php print $fetchEmployee["emp_users_firstname"].' '.$fetchEmployee["emp_users_middlename"].' '.$fetchEmployee["emp_users_lastname"]; ?></td>
                      <td><?php print $fetchEmployee["emp_pos_name"]; ?></td>
                      <td><?php print $fetchEmployee["emp_users_email"]; ?></td>
