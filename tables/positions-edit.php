<?php
  ...
  if(isset($_POST['btnUpdate'])) {
    ...
    $sqlUpdate = "UPDATE users_tbl SET pos_name='$txtPosition' WHERE pos_id=$id";
              ...
              <form method="post" role="form">
                <div class="card-body">
                  ...
                  <label for="exampleInputPosition1">Position</label>
                    <input type="text" class="form-control" id="examplePosition1" name="Position" value="<?php print $fetchPosition['pos_name']; ?>">
                  </div>
                </div>
                <!-- /.card-body -->
