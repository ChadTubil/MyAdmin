                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <button type="button" onclick="document.location.href='suppliers-view.php?id=<?php print $fetchSuppliers['supp_id']; ?>'" class="btn btn-primary" style="height: 25px; font-size: 12px; padding: 0px 10px;"><i class="far fa-edit"></i> VIEW</button>
